...
from bot import Bot
from config import ADMINS, FORCE_MSG, START_MSG, CUSTOM_CAPTION, DISABLE_CHANNEL_BUTTON, PROTECT_CONTENT, TG_BOT_USERNAME
from helper_func import subscribed, encode, decode, get_messages
from helpers import b64_to_str, str_to_b64, get_current_time, shorten_url
from database.database import add_user, del_user, full_userbase, present_user, collection
...
async def start_command(client: Client, message: Message):
    ...
    if uid not in ADMINS:
        ...
        if result is None:
            ...
            await client.send_message(
                message.chat.id,
                f"Hey bro **{message.from_user.mention}** \n\nYour Ads token is expired, refresh your token and try again. \n\n**Token Timeout:** 24 hour \n\n**What is token?** \nThis is an ads token. If you pass 1 ad, you can use the bot for 24 hour after passing the ad.<br> watch video tutorial if you're facing issue<br><a href='https://telegram.me/howtodownloadin/16'</a>,
